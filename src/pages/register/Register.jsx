...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch(apiArray.register.url, {
        method: apiArray.register.method,
      ...
      <div className={styles.illustration}>
        ...
        >
          ...
          <g>
            ...
            <g>
              <path
                id="uuid-00bc58e7-734f-4d7c-a085-03c0cd267642-448"
            ...
            />
            <path
              id="uuid-ece83039-1aa0-468e-a846-e0cb6ecd6032-449"
        ...
        <h2>Join Us!</h2>
        <p>Create your account to start managing your tasks effectively.</p>
      </div>
